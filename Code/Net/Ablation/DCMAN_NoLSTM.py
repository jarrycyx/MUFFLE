...
class Dual_Channel_Attention_Net_NoLSTM(nn.Module):

    def __init__(self, batchNorm=False, input_size=[240, 416], mode="train",
                 frame_num=7, lstm_layer=1):
        super(Dual_Channel_Attention_Net_NoLSTM, self).__init__()
        self.batchNorm = batchNorm
        self.mode = mode
        self.frame_num = frame_num
        self.lstm_layer = lstm_layer
...
if __name__ == "__main__":
    ...
    net = Dual_Channel_Attention_Net_NoLSTM(input_size=[120, 240], mode='debug')
